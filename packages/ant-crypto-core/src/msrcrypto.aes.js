...
var msrcryptoUtilities = require("ant-crypto-utils");
...
var _document = _global && _global.document || {};
var _attachEvent = _document.attachEvent || function () { };
var _detachEvent = _document.detachEvent || function () { };
var _syncMode = !!_global;
...
var msrCrypto = msrCrypto || (function () {
  ...
  // If window or global is undefined, don't use webWorkers.
  // Support for webWorkers IE10+.
  var webWorkerSupport = _syncMode && (typeof Worker !== "undefined");

  // Is this script running in an instance of a webWorker?
  var runningInWorkerInstance = _syncMode && (typeof importScripts !== "undefined");
  ...
  function MsrcryptoEntropy() {
    ...
    function collectEntropy() {
      ...
      var prngCrypto = typeof crypto !== "undefined" ? crypto : (typeof msCrypto !== "undefined" ? msCrypto : undefined);
      // WARNING: !!! Do not put this in a function (remember polyfill) !!!

      if (prngCrypto && typeof prngCrypto.getRandomValues === "function") {
        if (Uint8Array) {
          var res = new Uint8Array(poolLength);
        ...
        startCollectors: function () {
          if (!this.collectorsRegistered) {
            if (typeof addEventListener !== "undefined") {
              addEventListener("mousemove", this.MouseEventCallBack, true);
              addEventListener("load", this.LoadTimeCallBack, true);
            } else if (_attachEvent) {
              _attachEvent("onmousemove", this.MouseEventCallBack);
              _attachEvent("onload", this.LoadTimeCallBack);
            } else {
        ...
        stopCollectors: function () {
          if (this.collectorsRegistered) {
            if (typeof removeEventListener !== "undefined") {
              removeEventListener("mousemove", this.MouseEventCallBack, 1);
              removeEventListener("load", this.LoadTimeCallBack, 1);
            } else if (_detachEvent) {
              _detachEvent("onmousemove", this.MouseEventCallBack);
              _detachEvent("onload", this.LoadTimeCallBack);
            }
